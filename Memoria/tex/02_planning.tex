% ============================================================
%   Chapter 2  \textemdash\  Project Planning and Management
% ============================================================
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}lp{6.0cm}p{4.6cm}@{}}
    ...
    Planning              & Work breakdown, schedule, resource and risk plans
                          & This chapter \\
    Execution             & Iterative design\,$\to$\,implementation\,$\to$\,training\,$\to$\,analysis loops
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}llp{7.4cm}@{}}
    ...
    M6 & Jul 2026 & Thesis submitted and defended \\
    \bottomrule
  \end{tabular}
\end{table}
...
Figure~\ref{fig:gantt} shows the baseline schedule as a Gantt chart over the eleven months of the
...
\begin{figure}[H]
  ...
  \begin{ganttchart}[
      ...
      title height=1,
      bar height=0.66,
      bar/.append style={fill=black!55, draw=black!75, line width=0.4pt},
      bar label font=\footnotesize,
      title label font=\footnotesize,
      milestone/.append style={fill=black!80, draw=black!80},
      milestone label font=\footnotesize\itshape
    ]{1}{11}
    \gantttitle{2025}{4}\gantttitle{2026}{7} \\
    ...
    \ganttbar{WP0 Project management}{1}{11} \\
    \ganttbar{WP1 Research \& SOTA}{1}{3} \\
    \ganttbar{WP2 Environment \& wrappers}{2}{4} \\
    \ganttbar{WP3 PPO agent}{3}{5} \\
    \ganttbar{WP4 Safety shields}{4}{6} \\
    \ganttbar{WP5 Reward shaper}{4}{5} \\
    \ganttbar{WP6 Curriculum manager}{5}{6} \\
    \ganttbar{WP7 Metrics \& dashboard}{5}{6} \\
    \ganttbar{WP8 Experimentation}{6}{8} \\
    \ganttbar{WP9 Dependence study}{8}{9} \\
    \ganttbar{WP10 Thesis writing}{9}{11} \\
    \ganttmilestone{M1}{1} \\
    \ganttmilestone{M2}{3} \\
    \ganttmilestone{M3}{5} \\
    \ganttmilestone{M4}{7} \\
    \ganttmilestone{M5}{9} \\
    \ganttmilestone{M6}{11}
  \end{ganttchart}%
  }
  \caption{Baseline Gantt chart of the project (September 2025\,--\,July 2026). Bars are the
           ...
           project; the technical critical path runs WP2\,$\to$\,WP3\,$\to$\,WP4\,$\to$\,WP8\,$\to$\,WP9.}
  \label{fig:gantt}
\end{figure}
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}lp{5.8cm}cc@{}}
    ...
    \midrule
    \multicolumn{2}{r}{\textbf{Total}} & \textbf{550} & \\
    \bottomrule
  \end{tabular}
\end{table}
