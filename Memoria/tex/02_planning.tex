...
stages (Section~\ref{sec:plan-approach}) and decomposes it into a work breakdown structure with an
effort estimate (Section~\ref{sec:plan-wbs}). It then records the milestones
...
(writing) run continuously alongside the technical packages, and the remaining packages map directly
...
(WP9). Table~\ref{tab:precedence} records the precedences, and the resulting \emph{critical path} is
...
\begin{figure}[H]
  ...
  \caption{Baseline Gantt chart of the project (September 2025 to June 2026). Bars are the
           work packages of Table~\ref{tab:wbs} and diamonds are the milestones of
           Table~\ref{tab:milestones}. Management (WP0) and writing (WP10) span the whole
           project, and the technical critical path runs WP2, WP3, WP4, WP8 and WP9.}
  \label{fig:gantt}
\end{figure}
