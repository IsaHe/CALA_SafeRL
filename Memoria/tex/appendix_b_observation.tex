...
\begin{table}[h]
  ...
  \begin{tabular}{@{}cllp{6cm}@{}}
    ...
    723 & \texttt{lane\_width\_norm}        & \([0, 1]\) & Lane width at the current
        position, normalised by a reference width of \(4.0\,\mathrm{m}\). \\
...
\begin{table}[h]
  ...
  \begin{tabular}{@{}cllp{6cm}@{}}
    ...
    \textbf{Idx.} & \textbf{Name} & \textbf{Range} & \textbf{Meaning} \\
    \midrule
    732 & \texttt{speed\_norm} & \([0, 1]\) & Vehicle speed normalised by a reference speed
        of \(150\,\mathrm{km/h}\). \\
...
\begin{table}[h]
  ...
  \begin{tabular}{@{}cllp{6cm}@{}}
    ...
    737 & \texttt{speed\_limit\_norm}   & \([0, 1]\) & Current speed limit normalised by the
        reference speed. \\
    738 & \texttt{speed\_ratio}         & \([0, 1]\) & Ratio of the vehicle speed to the
        current speed limit. \\
    \bottomrule
  \end{tabular}
\end{table}
