% ============================================================
%   Chapter 3  \textemdash\  Project Budget
% ============================================================
...
role; Table~\ref{tab:labor-support} costs the support team (Director, Coordinator and tribunal),
...
Gemini incur no per-call cost, their compute being accounted for under energy
...
meetings; no travel or accommodation was required. This line is therefore \(0.00\)~€.
