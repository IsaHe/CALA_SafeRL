...
When an episode terminates (collision, off-road), the critic bootstrap value is set to zero; when
an episode is truncated by a step-count timeout, the critic value at the final observed state is
