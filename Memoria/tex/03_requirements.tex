...
maintainable it must be. They are grouped below by ISO/IEC~25010 quality dimension~\cite{iso2011quality}.
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}llp{7.8cm}@{}}
    ...
    NFR-04 & Maintainability         & Python source files shall pass \texttt{ruff check} with
        the project's default configuration, and public classes shall carry short docstrings. \\
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}lp{10cm}@{}}
    ...
    Hardware    & Single desktop workstation. A GPU with at least \(6\,\mathrm{GB}\) of VRAM is
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}llp{7.5cm}@{}}
    ...
    AC-02 & Crash rate             & With the adaptive shield, the 100-episode rolling
        ...
        unshielded probe. Empirically this is a factor of \(8\times\) (\(16\%\to 2\%\)), and the threshold is set conservatively at \(4\times\). \\
    AC-03 & Off-road rate          & Under the adaptive shield, the 100-episode rolling
        \texttt{offroad\_rate} shall remain below \(\beta=0.15\) (\(15\%\)).
        Empirically: \(0.0\%\) at training end and \(12\%\) in the \(50\)-episode evaluation. \\
