...
has 735 dimensions, combining three semantic LIDAR channels with lane, vehicle and route features
derived from the Waypoint API. Training stability is improved through running-mean observation
...
\noindent Safe Reinforcement Learning, Autonomous Driving, Safety Shield, Proximal Policy
Optimization, CARLA Simulator.
