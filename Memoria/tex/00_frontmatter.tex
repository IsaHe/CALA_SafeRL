...
chain of Gymnasium wrappers, allowing the agentL: two interchangeable safety shields, a
dense reward shaper and the simulator that can be combined with minimal coupling. 
