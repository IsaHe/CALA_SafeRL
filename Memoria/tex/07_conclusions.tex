...
\begin{itemize}
  ...
  \item \textbf{Reward-based collision avoidance.} After the behavioural-cloning weaning of
        Chapter~\ref{ch:dependence}, the only residual benefit of the shield is reducing the
        combined crash\,+\,off-road rate (from \(34\%\) to \(20\%\)). Because the shield is a poor longitudinal teacher
        (Section~\ref{sec:dep-collapse}), closing this gap is better posed as reward shaping: a
        time-to-collision or following-distance penalty would let the agent learn its \emph{own}
        gentle avoidance rather than cloning the shield's last-resort brake.
