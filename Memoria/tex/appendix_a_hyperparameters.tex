...
\begin{table}[h]
  ...
  \begin{tabular}{@{}llc@{}}
    ...
    Entropy coefficient (initial)  & \texttt{--entropy\_coef}     & \(0.001\) \\
    Entropy coefficient (final)    & \texttt{--entropy\_coef\_min}& \(0.0\) \\
    Entropy decay updates          & \texttt{--entropy\_coef\_decay\_updates} & \(50\) \\
